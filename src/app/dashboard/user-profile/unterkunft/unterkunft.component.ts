...
@Component({
  ...
  styleUrl: './unterkunft.component.scss'
})
export class UnterkunftComponent {
 ...
 @Input() userDetail: any = null;
  ...
  constructor(
    ...
    const formJson = this.formsJsonS.getTab9FormJson();
    this.createForm(formJson);
    this.tab1FormJson = this.formsJsonS.getTab9FormJson();
  }
  ...
  onFormSubmit(formValue: any) {
    const apiParams = {
      ...
      tab_9: JSON.stringify(formValue),
    };
