...
@Component({
  ...
  templateUrl: './info-de.component.html',
  styleUrl: './info-de.component.scss'
})
export class InfoDeComponent {
 ...
 @Input() categoory: string = 'healthcare';
  ...
  constructor(
    ...
    const formJson = this.formsJsonS.getTab12FormJson();

    this.createForm(formJson);
    this.tab1FormJson = this.formsJsonS.getTab12FormJson();
  }
  ...
  onFormSubmit(formValue: any) {
    const apiParams = {
      ...
      tab_2: JSON.stringify(formValue),
    };
